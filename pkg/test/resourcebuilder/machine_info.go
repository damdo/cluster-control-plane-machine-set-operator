...
// WithMachineCreationTimestamp sets the machine deletion timestamp for the machineinfo builder.
func (m MachineInfoBuilder) WithMachineCreationTimestamp(deletion metav1.Time) MachineInfoBuilder {
	m.machineCreationtimestamp = deletion
	return m
}
